...
- AWS EC2 Security Group showing exposed SSH and Telnet services
- Cowrie running on Ubuntu (`cowrie status`)
- Python threat report execution
- Generated threat report displaying attacker statistics
